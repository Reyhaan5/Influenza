...
const NAV_ITEMS = [
  ...
  { key: "campaigns", label: "Campaigns", icon: Megaphone, to: "/brand-dashboard/campaigns" },
  { key: "search", label: "Search Creators", icon: Search, to: "/brand-dashboard/search" },
  { key: "requests", label: "Requests", icon: Send, to: "/collaboration-requests" },
  { key: "collaborations", label: "Collaborations", icon: Users, to: "/brand-dashboard/collaborations" },
];
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <NavLink
              ...
              className={({ isActive }) =>
                `flex h-11 w-full items-center rounded-xl transition-colors duration-200 ${
                  isActive
